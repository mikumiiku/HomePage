...
入口 `/game/go`，支持电脑和手机。提供 9、13、19 路离线人机与同屏双人，采用中国规则、白贴 7.5 目、禁止自杀与全局同形再现；连续停一手后核对死子并按数子法计分。人机轻松/标准/深入三档使用约 200/800/2200ms 的本地 Web Worker 搜索，不依赖外部 API、在线模型或服务端存档。
